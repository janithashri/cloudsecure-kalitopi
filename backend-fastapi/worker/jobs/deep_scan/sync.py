...
from worker.jobs.deep_scan.queries import NODE_FETCH_QUERY
from worker.jobs.deep_scan.queries import NODE_SYNC_TEMPLATE
from worker.jobs.deep_scan.queries import RELATIONSHIP_SYNC_TEMPLATE
from worker.jobs.deep_scan.queries import RELATIONSHIPS_FETCH_QUERY
